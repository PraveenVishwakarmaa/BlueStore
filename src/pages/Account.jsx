...
const FormRegistration = () => {
  return (
    <div className="flex flex-col justify-center items-center w-full h-[100vh] px-5 text-black">
      <div className={`xl:max-w-3xl w-3/5 p-5 m-5 sm:p-10 rounded-xl border shadow-md`}>
        ...
        <div className="w-full mt-8">
          <div className="mx-auto max-w-xs sm:max-w-md md:max-w-lg flex flex-col gap-4">
            ...
            <p className="mt-6 text-xs text-gray-900 text-center">
